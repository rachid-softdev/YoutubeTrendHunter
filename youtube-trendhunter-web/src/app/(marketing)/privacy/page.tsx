        ...
        <div className="prose prose-invert max-w-none space-y-6 text-dark-ink-secondary">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong className="text-dark-ink">Données techniques</strong> : adresse IP, journaux
                d&apos;audit, identifiant de session lors de nos opérations de sécurité et de
                traçabilité.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Vous fournir le service TrendHunter (détection de tendances, alertes, extension).
              </li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <strong className="text-dark-ink">Stripe</strong> (paiements) — nom, email,
                identifiant de client.
              </li>
              <li>
                <strong className="text-dark-ink">Resend</strong> (envoi d&apos;emails) — adresse
                email.
              </li>
              <li>
              ...
              <li>
                <strong className="text-dark-ink">Sentry</strong> (monitoring d&apos;erreurs) —
                données techniques de débogage.
              </li>
              <li>
            ...
            <p>
              Ces sous-traitants peuvent être situés aux États-Unis. Les transferts
              s&apos;effectuent sur la base des garanties appropriées prévues par le RGPD (clauses
              contractuelles types ou certifications de protection adéquate).
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Vos données sont conservées pendant toute la durée de votre utilisation du service. À
              la suppression de votre compte, l&apos;ensemble de vos données sont supprimées de nos
              bases de données. Les journaux d&apos;audit sont conservés au maximum 12 mois à des
              fins de sécurité.
            </p>
          </section>
