      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-dark-ink-secondary">
          <section className="space-y-2">
            <h2 className="text-dark-ink text-xl font-bold">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                ...
                mesurent l&apos;audience et les comportements d&apos;utilisation afin
                d&apos;améliorer le service. Ils ne sont déposés qu&apos;après votre consentement.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              les cookies d&apos;analyse. Vous pouvez modifier votre choix à tout moment en effaçant
              les cookies de votre navigateur ou en utilisant les paramètres de votre navigateur.
            </p>
          </section>
