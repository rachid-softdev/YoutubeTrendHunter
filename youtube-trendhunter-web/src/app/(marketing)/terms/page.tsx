    ...
    <div className="min-h-screen bg-dark-canvas text-dark-ink py-20 px-4">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-dark-ink-secondary">
          <p>
            <strong className="text-dark-ink">
              En utilisant TrendHunter, vous acceptez les présentes conditions générales
              d&apos;utilisation.
            </strong>{" "}
            En vous inscrivant, en vous connectant ou en utilisant le service (notamment la
            plateforme web et l&apos;extension Chrome), vous reconnaissez avoir lu, compris et
            accepté l&apos;intégralité des dispositions ci-dessous.
          </p>

          <section className="space-y-2">
            <h2 className="text-dark-ink text-xl font-bold">1. Éditeur et acceptation</h2>
            <p>
              TrendHunter est édité par ABBOU Rachid (micro-entrepreneur), dont les informations
          ...
          <section className="space-y-2">
            ...
            <p>
              La plateforme, son code, son design, ses algorithmes et tous les contenus produits (à
              l&apos;exception des données YouTube) sont la propriété exclusive de TrendHunter.
          ...
          <section className="space-y-2">
            ...
            <p>
              TrendHunter fournit des données analytiques à titre indicatif. Nous ne garantissons ni
              l&apos;exactitude des données, ni les résultats de votre chaîne YouTube.
